...
# For rules that require multiple artifact graphs, repeat the copy command
...
DB.DBA.TTLP_MT(
  file_to_string_output('/usr/share/proj/mft_case.nt'),
  '',
...
DB.DBA.TTLP_MT(
  file_to_string_output('/usr/share/proj/usn_case.nt'),
  '',
...
DB.DBA.TTLP_MT(
  file_to_string_output('/usr/share/proj/history_case.nt'),
  '',
