...
artifacts:
  ...
  - IndexedDB
  - $UsnJrnl
invariant:    "Every domain encoded in an IndexedDB cache path must have a corresponding URL entry in the Chrome History database."
sparql_file:  ioi-002.rq
sparql_path:  RULES/semantic/IOI-002_chrome_history_missing.rq
